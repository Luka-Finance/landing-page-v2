...
export const financialFreedomContent = [
  {
    imageSRC: "asset/dashboard.png",
  ...
  {
    imageSRC: "asset/mobile-app.png",
    heading: "Employee Mobile App",
    details:
      "Employees can easily acess funds and perform transactions on the go from the mobile app",
    location: {
      bottom: "0",
      right: "0",
    },
